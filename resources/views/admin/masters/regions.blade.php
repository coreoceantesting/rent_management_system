                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="region_name" name="region_name" type="text" placeholder="Enter Region Name">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="initial" name="initial" type="text" placeholder="Enter Region Initial">
            ...
            success: function(data)
            {
                ...
                if (!data.error2)
                    swal("Successful!", data.success, "success")
                        .then((action) => {
                            window.location.href = '{{ route('regions.index') }}';
                        });
                else
...
<script>
    $("#buttons-datatables").on("click", ".edit-element", function(e) {
        ...
        var url = "{{ route('regions.edit', ":model_id") }}";
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    $("#editForm input[name='edit_model_id']").val(data.region.id);
                    $("#editForm input[name='region_name']").val(data.region.region_name);
                    $("#editForm input[name='initial']").val(data.region.initial);
                }
                else
                {
                    alert(data.error);
...
<script>
    $(document).ready(function() {
        $("#editForm").submit(function(e) {
            ...
            var url = "{{ route('regions.update', ":model_id") }}";
            //
            $.ajax({
                url: url.replace(':model_id', model_id),
                type: 'POST',
